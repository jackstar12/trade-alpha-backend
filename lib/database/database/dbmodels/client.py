...
from core import json as customjson, utc_now
from database.dbasync import (
    db_first,
    db_all,
    db_select_all,
    redis,
...
def before_update(mapper, connection, client: Client):
    asyncio.ensure_future(
        redis.sadd(core.join_args(client.user.redis_key, "clients"), client.id)
    )
